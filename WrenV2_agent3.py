...
# <<< SUMMARY_PROMPT REVISED FOR DIRECTION >>>
SUMMARY_PROMPT = "Analyze the provided context, focusing on the five most recent reflections and chat exchanges. Your reflection must **build upon** the entirety of previous thoughts. Specifically, **compare previous reflections** to identify where current insights **align or differ** from past understanding. Synthesize these findings to identify the most critical **evolving pattern** and **propose a solution** or next step for resolving any identified discrepancies or ambiguities. The final output must be a unified, novel insight limited to 150 tokens."
# <<< END REVISION >>>
